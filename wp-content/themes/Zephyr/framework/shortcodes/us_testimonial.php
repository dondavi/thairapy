...
$output = '<div class="w-testimonials' . $classes . '">';
$output .= '<div class="w-testimonial"><blockquote class="w-testimonial-h">';
...
if ( ! empty( $image_html ) OR ! empty( $atts['author'] ) OR ! empty( $atts['company'] ) ) {
	...
	if ( ! empty( $atts['author'] ) ) {
		$output .= '<span class="w-testimonial-author-name"><span>' . $atts['author'] . '</span></span>';
	}
