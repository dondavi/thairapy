 ...
 *
 * @action Before the template: 'us_before_template:templates/form/email'
 * @action After the template: 'us_after_template:templates/form/email'
 * @filter Template variables: 'us_template_vars:templates/form/email'
 */
...
<div class="w-form-row for_<?php echo $name ?><?php echo $classes ?>">
	...
	<div class="w-form-row-field">
		...
		<input type="email" name="<?php echo esc_attr( $name ) ?>" id="<?php echo $id ?>" value="<?php echo esc_attr( $value ) ?>"
