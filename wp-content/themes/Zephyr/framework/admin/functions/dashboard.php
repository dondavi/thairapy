	...
	<div class="wrap about-wrap us-home">
		...
		<div class="us-features">
			<div class="one-third">
				...
				<p><?php echo sprintf( __( '%s comes with popular premium plugins which greatly increase possibilities of the theme. You can use them for free!', 'us' ), US_THEMENAME ); ?></p>
