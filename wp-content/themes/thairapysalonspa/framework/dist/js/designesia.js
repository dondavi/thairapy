...
jQuery(document).ready(function() {		
  ...
  var homepage_url = 'http://inspiredroots.com/thairapy/';
	...
	var logo_dir_1				= '/thairapy/wp-content/themes/thairapysalonspa/framework/dist/img/logo-light.png'; // change with your logo path
	var logo_dir_2				= '/thairapy/wp-content/themes/thairapysalonspa/framework/dist/img/logo-dark.png'; // change with your logo path (for light background)
	...
	function h_center_logo(){
		...
		jQuery('.header_center ul#mainmenu > li').each(function() {
			if(i === Math.floor(position/2)-1) {
				jQuery(this).after('<li class="logo_pos"><a href="' + homepage_url + '"><img class="c_logo_light" src="'+logo_dir_1+'"/><img class="c_logo_dark" src="'+logo_dir_2+'"/></a></li>');
			}
			i++;
		});
