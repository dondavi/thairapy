...
*/
if(!function_exists('ult_price_generate_design01')) {
function ult_price_generate_design01($atts,$content = null){
	...
	$ult_price_table_ht='';	$price_normal_style='';
	   if($min_ht != ''){
	...
	$output .= '<div class="ult_pricing_table_wrap ult_design_1 '.$featured.' ult-cs-'.$color_scheme.' '.$el_class.' '.$css_price_box.'">
				<div class="ult_pricing_table '.$ult_price_table_ht.'" style="'.$featured_style.' '.$price_normal_style.'">';

		$output .= '<div class="ult_pricing_heading" id="'.$price_table_id.'">
						<h3 class="cust-headformat ult-responsive" '.$price_table_data_list.' style="'.$package_name_inline.'">'.$package_heading.'</h3>';
					if($package_sub_heading !== ''){
						$output .= '<h5 '.$price_table_subhead_data_list.' class="cust-subhead ult-responsive" style="'.$sub_heading_inline.'">'.$package_sub_heading.'</h5>';
					}
