...
*/
if(!function_exists('ult_info_table_generate_design04')) {
	function ult_info_table_generate_design04($atts,$content = null){
		...
		$output .= '<div class="ult_pricing_table_wrap ult_info_table ult_design_4 '.$featured.' ult-cs-'.$color_scheme.' '.$el_class.' '.$css_info_tables.'">
					<div class="ult_pricing_table '.$info_tab_ht.'" style="'.$normal_style.' '.$info_tab_ht_style.'">';
			$output .= '<div id="'.$info_table_id.'" class="ult_pricing_heading">
							<h3 class="ult-responsive" '.$info_table_data_list.' style="'.$heading_style_inline.'">'.$package_heading.'</h3>';
						if($package_sub_heading !== ''){
							$output .= '<h5 class="ult-responsive" style="'.$sub_heading_inline.'">'.$package_sub_heading.'</h5>';
						}
