...
*/
if(!function_exists('ult_info_table_generate_design02')) {
	function ult_info_table_generate_design02($atts,$content = null){
		...
		$output .= '<div class="ult_pricing_table_wrap ult_info_table ult_design_2 '.$featured.' ult-cs-'.$color_scheme.' '.$el_class.''.$css_info_tables.'">
